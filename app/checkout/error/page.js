...
export default function CheckoutErrorPage() {
  return (
    <main className="max-w-xl mx-auto px-4 py-20 text-center">
      ...
      <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">Hubo un problema con el pago</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 border border-gray-300 text-gray-700 font-semibold px-8 py-4 rounded-xl hover:bg-gray-100 hover:text-black transition-colors"
        >
          <FaWhatsapp />
